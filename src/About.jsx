...
function About() {
    return (
        <Container fluid className="slanted-bg-2">
            ...
            <p className="about-text">In 2022, I decided to pursue my passion in Front End Development. Taking on a new challenge is by no means an easy feat, but perserverance allowed me to absorb the new concepts quickly, and I strive to keep on improving as the days pass.</p>
            <p className="about-text">My hobbies include basketball, drafting new projects, cooking, as well as studying social sciences. I occasionally do personal food reviews too.</p>
            </Col>
            </Row>
        </Container>
    )
